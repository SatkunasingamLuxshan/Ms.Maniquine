        ...
        <div class="containera">
            ...
            <div class="righta">
                <div class="adminsetting">
                    <div class="adminsettingleft">
                        <form action="" method="POST" enctype="multipart/form-data">
                        <h2> Change Avatar</h2>
                            <label for="file-upload" class="adminsettingimagelbl">
                            <img src="clou.png" ></label>
                            <input id="file-upload" type="file"/>
                            <input type="submit" name="upload " value="Upload New Photo">
                        </div>
                        <div class="adminsettingright">
                            ...
                            <table>
                                ...
                                <tr >
                                    <td colspan="2">
                                        ...
                                        <input type="textarea" name="about"><br> 
                                    </td> 
                                </tr>
                            </table>
                            <input type="submit" name="settingupdate " value="Update Profile">
                        </form>
                    </div>
                </div>
            </div>
